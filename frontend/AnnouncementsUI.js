// ===== CosmoHub Announcements - Vercel Version =====
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    categoryDropdown.querySelector('.dropdown-menu').addEventListener('click', e => e.stopPropagation());
    ...
    function setActiveTab(filter) {
        ...
        tabs.forEach(tab => tab.classList.toggle('active', tab.dataset.tab === filter));
        renderAnnouncements();
    }
    ...
    function setActiveCategory(category) {
        ...
        if (activeItem) currentCategoryLabel.textContent = activeItem.querySelector('span').textContent;
    ...
    function renderAnnouncements() {
        ...
        if (filtered.length === 0) {
            container.innerHTML = `<div class="empty-state"><i data-lucide="megaphone"></i><p>No announcements in this category</p></div>`;
                ...
                <div class="announcement-meta">
                    ...
                    <div class="announcement-author">
                        <div class="author-info">
                            <span class="author-name">${ann.author_name}</span>
    ...
    function renderHighlights() {
        ...
        highlights.forEach(hl => {
            ...
            item.innerHTML = `
                <div class="highlight-icon-wrap ${hl.color}"><i data-lucide="${hl.icon}"></i></div>
    ...
    document.getElementById('modal-publish').addEventListener('click', function() {
        ...
        setTimeout(() => { modalOverlay.classList.remove('open'); this.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg><span>Publish</span>'; }, 800);
    });
    ...
    console.log('%c📢 CosmoHub Announcements (Vercel)', 'color: #a855f7; font-size: 16px; font-weight: bold;');
});
